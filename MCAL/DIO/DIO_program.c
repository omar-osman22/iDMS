...
void MDIO_vInt (void)
{
	/* Port A: All ADC inputs — set DDR to 0x00 (all input) */
	...
	/* Port B: ISP (PB0/PB3 inputs), LEDs/buzzer/PWM (PB1/PB2/PB4-PB7 outputs) */
	...
	/* Port C: GSM reset (PC0), relays (PC2/PC3) outputs; status/inputs for rest */
	...
	/* Port D: UART0 TX (PD1) output; RX and interrupts (PD0/PD2-PD7) inputs */
	...
	/* Port E: UART1 TX (PE1), SPI CS (PE3-PE5) outputs; RX and others inputs */
	DDRE = CONCAT(DIO_PIN_E7_DIR,DIO_PIN_E6_DIR,DIO_PIN_E5_DIR,DIO_PIN_E4_DIR,DIO_PIN_E3_DIR,DIO_PIN_E2_DIR,DIO_PIN_E1_DIR,DIO_PIN_E0_DIR);
	/* Port F: All ADC / JTAG inputs except PF6 (JTAG TDO output) */
	DDRF = CONCAT(DIO_PIN_F7_DIR,DIO_PIN_F6_DIR,DIO_PIN_F5_DIR,DIO_PIN_F4_DIR,DIO_PIN_F3_DIR,DIO_PIN_F2_DIR,DIO_PIN_F1_DIR,DIO_PIN_F0_DIR);
	/* Port G: Crystal, watchdog, status outputs; buttons/crystal-in inputs */
	DDRG = CONCAT(DIO_PIN_G4_DIR,DIO_PIN_G3_DIR,DIO_PIN_G2_DIR,DIO_PIN_G1_DIR,DIO_PIN_G0_DIR,0,0,0);
}
